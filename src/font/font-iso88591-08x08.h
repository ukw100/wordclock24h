#define FONT_WIDTH_08x08    8
#define FONT_HEIGHT_08x08   8

const unsigned char font_08x08[256][8]={
...
{0x10,0x38,0x7C,0xFE,0x7C,0x38,0x10,0x00},        // 0x80
{0x22,0x88,0x22,0x88,0x22,0x88,0x22,0x88},        // 0x81
...
{0x18,0x18,0x18,0x18,0xF8,0x00,0x00,0x00},        // 0x8A
{0x00,0x00,0x00,0x00,0xF8,0x18,0x18,0x18},        // 0x8B
{0x00,0x00,0x00,0x00,0x1F,0x18,0x18,0x18},        // 0x8C
{0x18,0x18,0x18,0x18,0x1F,0x00,0x00,0x00},        // 0x8D
{0x18,0x18,0x18,0x18,0xFF,0x18,0x18,0x18},        // 0x8E
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},        // 0x8F
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},        // 0x90
{0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x00},        // 0x91
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},        // 0x92
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},        // 0x93
{0x18,0x18,0x18,0x18,0x1F,0x18,0x18,0x18},        // 0x94
{0x18,0x18,0x18,0x18,0xF8,0x18,0x18,0x18},        // 0x95
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},        // 0x96
{0x00,0x00,0x00,0x00,0xFF,0x18,0x18,0x18},        // 0x97
{0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18},        // 0x98
...
{0x00,0x18,0x00,0x18,0x18,0x3C,0x3C,0x18},        // 0xA1
{0x18,0x18,0x7E,0xC0,0xC0,0x7E,0x18,0x18},        // 0xA2
{0x38,0x6C,0x64,0xF0,0x60,0xE6,0xFC,0x00},        // 0xA3
{0x00,0x82,0xFE,0x6C,0x6C,0xFE,0x82,0x00},        // 0xA4
{0xCC,0xCC,0x78,0xFC,0x30,0xFC,0x30,0x30},        // 0xA5
{0x18,0x18,0x18,0x00,0x18,0x18,0x18,0x00},        // 0xA6
{0x7E,0xC3,0x78,0xCC,0xCC,0x78,0x8C,0xF8},        // 0xA7
{0x00,0xCC,0x00,0x00,0x00,0x00,0x00,0x00},        // 0xA8
{0x3C,0x42,0xB9,0xA1,0xB9,0x42,0x3C,0x00},        // 0xA9
{0x3C,0x6C,0x6C,0x3E,0x00,0x7E,0x00,0x00},        // 0xAA
{0x00,0x33,0x66,0xCC,0x66,0x33,0x00,0x00},        // 0xAB
{0x00,0x00,0x00,0xFC,0x0C,0x0C,0x00,0x00},        // 0xAC
{0x00,0x00,0x00,0x00,0xFC,0x00,0x00,0x00},        // 0xAD
{0x3C,0x5A,0xA5,0xB9,0xA9,0x66,0x3C,0x00},        // 0xAE
{0x00,0xFC,0x00,0x00,0x00,0x00,0x00,0x00},        // 0xAF
{0x38,0x6C,0x6C,0x38,0x00,0x00,0x00,0x00},        // 0xB0
{0x30,0x30,0xFC,0x30,0x30,0x00,0xFC,0x00},        // 0xB1
{0x78,0x0C,0x38,0x60,0x7C,0x00,0x00,0x00},        // 0xB2
{0x7C,0x0E,0x3C,0x0E,0x7C,0x00,0x00,0x00},        // 0xB3
{0x18,0x30,0x00,0x00,0x00,0x00,0x00,0x00},        // 0xB4
{0x00,0x66,0x66,0x66,0x66,0x7C,0x60,0xC0},        // 0xB5
{0x7F,0xDB,0xDB,0x7B,0x1B,0x1B,0x1B,0x00},        // 0xB6
{0x00,0x00,0x00,0x00,0x18,0x00,0x00,0x00},        // 0xB7
{0x00,0x00,0x00,0x00,0x00,0x00,0x30,0x60},        // 0xB8
{0x38,0x78,0x18,0x18,0x7E,0x00,0x00,0x00},        // 0xB9
{0x3C,0x66,0x66,0x3C,0x00,0x7E,0x00,0x00},        // 0xBA
{0x00,0xCC,0x66,0x33,0x66,0xCC,0x00,0x00},        // 0xBB
{0xE6,0x6C,0x78,0x73,0x67,0xCD,0x9F,0x03},        // 0xBC
{0xE6,0x6C,0x78,0x7E,0x63,0xCE,0x98,0x1F},        // 0xBD
{0xE6,0x2C,0x78,0x33,0xE7,0xCD,0x9F,0x03},        // 0xBE
{0x30,0x00,0x30,0x60,0xC0,0xCC,0x78,0x00},        // 0xBF
{0xC0,0x60,0x30,0x78,0xCC,0xFC,0xCC,0x00},        // 0xC0
{0x0C,0x18,0x30,0x78,0xCC,0xFC,0xCC,0x00},        // 0xC1
{0x78,0x84,0x30,0x78,0xCC,0xFC,0xCC,0x00},        // 0xC2
{0x76,0xDC,0x30,0x78,0xCC,0xFC,0xCC,0x00},        // 0xC3
{0xCC,0x30,0x78,0xCC,0xCC,0xFC,0xCC,0x00},        // 0xC4
{0x30,0x48,0x30,0x78,0xCC,0xFC,0xCC,0x00},        // 0xC5
{0x3E,0x6C,0xCC,0xFE,0xCC,0xCC,0xCE,0x00},        // 0xC6
{0x78,0xCC,0xC0,0xC0,0xCC,0x78,0x30,0x60},        // 0xC7
{0x60,0x30,0xFC,0x60,0x78,0x60,0xFC,0x00},        // 0xC8
{0x18,0x30,0xFC,0x60,0x78,0x60,0xFC,0x00},        // 0xC9
{0x78,0x84,0xFC,0x60,0x78,0x60,0xFC,0x00},        // 0xCA
{0xCC,0x00,0xFC,0x60,0x78,0x60,0xFC,0x00},        // 0xCB
{0x60,0x30,0x78,0x30,0x30,0x30,0x78,0x00},        // 0xCC
{0x18,0x30,0x78,0x30,0x30,0x30,0x78,0x00},        // 0xCD
{0x78,0x84,0x78,0x30,0x30,0x30,0x78,0x00},        // 0xCE
{0xCC,0x00,0x78,0x30,0x30,0x30,0x78,0x00},        // 0xCF
{0xFC,0x6C,0x66,0xF6,0x66,0x6C,0xFC,0x00},        // 0xD0
{0x76,0xDC,0x00,0xEC,0xFC,0xDC,0xCC,0x00},        // 0xD1
{0x30,0x18,0x7C,0xC6,0xC6,0xC6,0x7C,0x00},        // 0xD2
{0x18,0x30,0x7C,0xC6,0xC6,0xC6,0x7C,0x00},        // 0xD3
{0x7C,0x82,0x7C,0xC6,0xC6,0xC6,0x7C,0x00},        // 0xD4
{0x76,0xDC,0x7C,0xC6,0xC6,0xC6,0x7C,0x00},        // 0xD5
{0xC6,0x00,0x7C,0xC6,0xC6,0xC6,0x7C,0x00},        // 0xD6
{0x00,0x00,0xCC,0x78,0x30,0x78,0xCC,0x00},        // 0xD7
{0x3A,0x6C,0xCE,0xD6,0xE6,0x6C,0xB8,0x00},        // 0xD8
{0x60,0x30,0xCC,0xCC,0xCC,0xCC,0x78,0x00},        // 0xD9
{0x18,0x30,0xCC,0xCC,0xCC,0xCC,0x78,0x00},        // 0xDA
{0x78,0x84,0x00,0xCC,0xCC,0xCC,0x78,0x00},        // 0xDB
{0xCC,0x00,0xCC,0xCC,0xCC,0xCC,0x78,0x00},        // 0xDC
{0x18,0x30,0xCC,0xCC,0x78,0x30,0x78,0x00},        // 0xDD
{0xF0,0x60,0x7C,0x66,0x7C,0x60,0xF0,0x00},        // 0xDE
{0x00,0x78,0xCC,0xF8,0xCC,0xF8,0xC0,0xC0},        // 0xDF
{0x60,0x30,0x78,0x0C,0x7C,0xCC,0x7E,0x00},        // 0xE0
{0x18,0x30,0x78,0x0C,0x7C,0xCC,0x7E,0x00},        // 0xE1
{0x7E,0xC3,0x3C,0x06,0x3E,0x66,0x3F,0x00},        // 0xE2
{0x76,0xDC,0x78,0x0C,0x7C,0xCC,0x7E,0x00},        // 0xE3
{0xCC,0x00,0x78,0x0C,0x7C,0xCC,0x7E,0x00},        // 0xE4
{0x3C,0x66,0x3C,0x06,0x3E,0x66,0x3F,0x00},        // 0xE5
{0x00,0x00,0x7F,0x0C,0x7F,0xCC,0x7F,0x00},        // 0xE6
{0x00,0x78,0xCC,0xC0,0xCC,0x78,0x30,0x60},        // 0xE7
{0x60,0x30,0x78,0xCC,0xFC,0xC0,0x78,0x00},        // 0xE8
{0x18,0x30,0x78,0xCC,0xFC,0xC0,0x78,0x00},        // 0xE9
{0x7E,0xC3,0x3C,0x66,0x7E,0x60,0x3C,0x00},        // 0xEA
{0xCC,0x00,0x78,0xCC,0xFC,0xC0,0x78,0x00},        // 0xEB
{0x60,0x30,0x70,0x30,0x30,0x30,0x78,0x00},        // 0xEC
{0x18,0x30,0x70,0x30,0x30,0x30,0x78,0x00},        // 0xED
{0x7C,0xC6,0x38,0x18,0x18,0x18,0x3C,0x00},        // 0xEE
{0xCC,0x00,0x70,0x30,0x30,0x30,0x78,0x00},        // 0xEF
{0xD8,0x70,0xD8,0x0C,0x3C,0x6C,0x38,0x00},        // 0xF0
{0x76,0xDC,0x00,0xF8,0xCC,0xCC,0xCC,0x00},        // 0xF1
{0x60,0x30,0x00,0x78,0xCC,0xCC,0x78,0x00},        // 0xF2
{0x0C,0x18,0x00,0x78,0xCC,0xCC,0x78,0x00},        // 0xF3
{0x78,0xCC,0x00,0x78,0xCC,0xCC,0x78,0x00},        // 0xF4
{0x76,0xDC,0x00,0x78,0xCC,0xCC,0x78,0x00},        // 0xF5
{0x00,0xCC,0x00,0x78,0xCC,0xCC,0x78,0x00},        // 0xF6
{0x30,0x30,0x00,0xFC,0x00,0x30,0x30,0x00},        // 0xF7
{0x00,0x00,0x7C,0xCE,0xD6,0xE6,0x7C,0x00},        // 0xF8
{0x60,0x30,0x00,0xCC,0xCC,0xCC,0x7E,0x00},        // 0xF9
{0x0C,0x18,0x00,0xCC,0xCC,0xCC,0x7E,0x00},        // 0xFA
{0x78,0xCC,0x00,0xCC,0xCC,0xCC,0x7E,0x00},        // 0xFB
{0x00,0xCC,0x00,0xCC,0xCC,0xCC,0x7E,0x00},        // 0xFC
{0x18,0x30,0x00,0xCC,0xCC,0xFC,0x0C,0xF8},        // 0xFD
{0x00,0xE0,0x78,0x6C,0x78,0x60,0xF0,0x00},        // 0xFE
{0x00,0xCC,0x00,0xCC,0xCC,0xFC,0x0C,0xF8}         // 0xFF
};
