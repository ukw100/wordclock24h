/*-------------------------------------------------------------------------------------------------------------------------------------------
 * tables12h-de2.c - tables for german WordClock12h
 *
...
const WORD_ILLUMINATION illumination[WP_COUNT] =
{
    ...
    {3,0,3},                                                        // 10 = WP_VOR          = "VOR"
    {3,7,4},                                                        // 11 = WP_NACH         = "NACH"
    {4,0,4},                                                        // 12 = WP_HALB         = "HALB"
    {4,5,3},                                                        // 13 = WP_ELF          = "ELF"
    {4,7,4},                                                        // 14 = WP_FUENF_2      = "FÜNF"
    {5,0,3},                                                        // 15 = WP_EIN          = "EIN"
    {5,0,4},                                                        // 16 = WP_EINS         = "EINS"
    {5,7,4},                                                        // 17 = WP_ZWEI         = "ZWEI"
    {6,0,4},                                                        // 18 = WP_DREI_2       = "DREI"
    {6,7,4},                                                        // 19 = WP_VIER_2       = "VIER"
    {7,0,5},                                                        // 20 = WP_SECHS        = "SECHS"
    {7,7,4},                                                        // 21 = WP_ACHT         = "ACHT"
    {8,0,6},                                                        // 22 = WP_SIEBEN       = "SIEBEN"
    {8,6,5},                                                        // 23 = WP_ZWOELF       = "ZWÖLF"
    {9,0,4},                                                        // 24 = WP_ZEHN_2       = "ZEHN"
    {9,3,4},                                                        // 25 = WP_NEUN         = "NEUN"
    {9,8,3},                                                        // 26 = WP_UHR          = "UHR"
    {1,8,3},                                                        // 27 = WP_ZIG          = "ZIG"
};
